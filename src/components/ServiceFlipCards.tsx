      ...
      {services.map((service, i) => (
        <Reveal key={service.slug} delay={(i % 4) * 70}>
          <Link
            ...
            className="group/flip block h-60 rounded-editorial [perspective:1200px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zonnegeel focus-visible:ring-offset-2 focus-visible:ring-offset-kobalt"
          >
            <div className="relative h-full w-full transition-transform duration-500 [transform-style:preserve-3d] group-hover/flip:[transform:rotateY(180deg)] group-focus-visible/flip:[transform:rotateY(180deg)] motion-reduce:transition-none">
              {/* Voorkant */}
              <div className="absolute inset-0 flex flex-col justify-between rounded-editorial bg-creme p-6 [backface-visibility:hidden]">
              ...
              {/* Achterkant */}
              <div className="absolute inset-0 flex flex-col justify-between rounded-editorial bg-zonnegeel p-6 [transform:rotateY(180deg)] [backface-visibility:hidden]">
